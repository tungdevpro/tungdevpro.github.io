...
declare module 'astro:content' {
	...
	type ContentEntryMap = {
		"blog": {
"2026-07-23-android-app-structure-overview.md": {
	id: "2026-07-23-android-app-structure-overview.md";
...
"golang-ban-than-hieu-the-nao-pubsub-p1.md": {
	id: "golang-ban-than-hieu-the-nao-pubsub-p1.md";
  slug: "golang-hieu-the-nao-ve-pubsub";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"khai-niem-liskov-substitution-principle.md": {
	id: "khai-niem-liskov-substitution-principle.md";
  slug: "solid-liskov-substitution-principle";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"khai-niem-open-close-principle.md": {
	id: "khai-niem-open-close-principle.md";
...
"swiftui-binding-la-gi.md": {
	id: "swiftui-binding-la-gi.md";
  slug: "swiftui-binding-la-gi";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"tim-hieu-khai-niem-ve-SOLID-principles.md": {
	id: "tim-hieu-khai-niem-ve-SOLID-principles.md";
